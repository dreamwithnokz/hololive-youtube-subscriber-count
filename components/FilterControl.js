  ...
  render () {
    return (
      <div className={this.props.collapse ? 'collapse' : ''}>
        <span className="me-4" style={{ color: '#dedede', fontWeight: 'bold', fontSize: 14 }}>Filters</span>
        <Button className="btn-sm btn-danger py-0 me-1" onClick={this.handleSelectAllClick}>All</Button>
